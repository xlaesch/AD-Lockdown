...
$GPO_Win11_BitLocker = "MSFT Windows 11 25H2 - BitLocker"
$GPO_Win11_Computer  = "MSFT Windows 11 25H2 - Computer"
$GPO_Win11_CredentialGuard = "MSFT Windows 11 25H2 - Credential Guard"
$GPO_Win11_DefenderAV  = "MSFT Windows 11 25H2 - Defender Antivirus"
$GPO_Win11_DomainSec   = "MSFT Windows 11 25H2 - Domain Security"
$GPO_Win11_User      = "MSFT Windows 11 25H2 - User"
