...
$GPO_Win10_BitLocker = "MSFT Windows 10 22H2 - BitLocker"
$GPO_Win10_Computer  = "MSFT Windows 10 22H2 - Computer"
$GPO_Win10_User      = "MSFT Windows 10 22H2 - User"
$GPO_Win10_DefenderAV  = "MSFT Windows 10 22H2 - Defender Antivirus"
$GPO_WS_DefenderAV  = "MSFT Windows Server 20H2 - Defender Antivirus"
$GPO_Win10_DomainSec   = "MSFT Windows 10 22H2 - Domain Security"
$GPO_WS_DomainSec   = "MSFT Windows Server 20H2 - Domain Security"
$GPO_Win10_CredentialGuard = "MSFT Windows 10 22H2 - Credential Guard"
