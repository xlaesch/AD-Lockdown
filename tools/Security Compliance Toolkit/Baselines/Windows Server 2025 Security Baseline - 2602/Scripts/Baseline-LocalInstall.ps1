...
$GPO_WS_DefenderAV  = "MSFT Windows Server 2025 v2602 - Defender Antivirus"
$GPO_WS_DC           = "MSFT Windows Server 2025 v2602 - Domain Controller"
$GPO_WS_DC_VBS       = "MSFT Windows Server 2025 v2602 - Domain Controller Virtualization Based Security"
$GPO_WS_DomainSec   = "MSFT Windows Server 2025 v2602 - Domain Security"
$GPO_WS_Member       = "MSFT Windows Server 2025 v2602 - Member Server"
$GPO_WS_CredentialGuard = "MSFT Windows Server 2025 v2602 - Member Server Credential Guard"
