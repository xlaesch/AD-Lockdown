...
$GPO_Win10_BitLocker = "MSFT Windows 10 20H2 - BitLocker"
$GPO_Win10_Computer  = "MSFT Windows 10 20H2 - Computer"
$GPO_Win10_User      = "MSFT Windows 10 20H2 - User"
$GPO_All_DefenderAV  = "MSFT Windows 10 20H2 and Server 20H2 - Defender Antivirus"
$GPO_All_DomainSec   = "MSFT Windows 10 20H2 and Server 20H2 - Domain Security"
$GPO_CredentialGuard = "MSFT Windows 10 20H2 and Server 20H2 Member Server - Credential Guard"
